...
def public_pages():
    return {
        "Config Generator": [
            ...
            st.Page("frontend/pages/config/dman_maker_v2/app.py", title="D-Man Maker V2", icon="🤖",
                    url_path="dman_maker_v2"),
            st.Page("frontend/pages/config/bollinger_v1/app.py", title="Bollinger V1", icon="📈",
                    url_path="bollinger_v1"),
            st.Page("frontend/pages/config/macd_bb_v1/app.py", title="MACD_BB V1", icon="📊", url_path="macd_bb_v1"),
            st.Page("frontend/pages/config/supertrend_v1/app.py", title="SuperTrend V1", icon="👨‍🔬",
                    url_path="supertrend_v1"),
            st.Page("frontend/pages/config/xemm_controller/app.py", title="XEMM Controller", icon="⚡️",
                    url_path="xemm_controller"),
            st.Page("frontend/pages/config/assignment_manager_v1/app.py", title="Assignment Manager v1", icon="🎯",
                    url_path="assignment_manager_v1"),
        ],
        "Data": [
            st.Page("frontend/pages/data/download_candles/app.py", title="Download Candles", icon="💹",
...
def private_pages():
    return {
        "Bot Orchestration": [
            ...
            st.Page("frontend/pages/orchestration/launch_bot_v2/app.py", title="Deploy V2", icon="🚀",
                    url_path="launch_bot_v2"),
            st.Page("frontend/pages/orchestration/credentials/app.py", title="Credentials", icon="🔑",
            ...
            st.Page("frontend/pages/orchestration/archived_bots/app.py", title="Archived Bots", icon="🗃️",
